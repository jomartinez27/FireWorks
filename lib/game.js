...
function animate() {
  ...
  if (pressed === true) {
    ...
    for (var i = 0; i < colors.cannonballColor.length; i++) {
      colors.cannonballColor[i]
    }

    cannonballs.push(new Cannonball(mouse.x, mouse.y, 2, 2, 10, colors.cannonballColor[i], cannon, colors.particleColors[i]));
    pressed = false;
  }
}
